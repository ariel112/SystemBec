			    ...
			    <figure >			
				      <!-- aqui va el codigo de la imagen-->
	                   @if($becarios->images==null && $becarios->genero=="Masculino" )
	                    ...
	                    <a href="#" class="image"><img src="{{asset('images/masculino.jpg')}}" alt="Maculino" /></a>
	                   @elseif($becarios->images==null && $becarios->genero=="Femenino" )
	                  	<a href="#" class="image"><img src="{{asset('images/femenino.jpg')}}" alt="Maculino" /></a> 
...
<footer class="ariel">
				  ...
				  <div style="width: 290px; height: 200px; float: right;">
						...
						<a id="espaciados" href=""><font face="Comic Sans MS,arial,verdana" class="glyphicon glyphicon-folder-open" size="5"> horas de actividad</font></a>
						<a id="espaciados" href=""><font face="Comic Sans MS,arial,verdana" class="glyphicon glyphicon-folder-open" size="5"> Historial de las horas</font></a>
